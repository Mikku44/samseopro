...
export const meta: MetaFunction = () => {
  return [
    { title: "Same SEO Pro" },
    { name: "description", content: "SamSEOPro - บริการ SEO แบบมืออาชีพ" },
    {
      name: "keywords",
      content: "SEO, การตลาดออนไลน์, คอร์ส SEO, ผู้เชี่ยวชาญ SEO",
    },
    { property: "og:title", content: "SamSEOPro - บริการ SEO แบบมืออาชีพ" },
    {
  ...
  return (
    <Layout>
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  <span className="bg-teal-100 px-2 py-1 inline-block">
                    SamSEOPro
                  </span>{" "}
                  ·<br />
              ...
              <div className="mx-auto lg:mx-0 lg:flex lg:justify-end">
                <div className="relative h-[350px] w-full max-w-[450px]">
                  <img
                    src="https://images.unsplash.com/photo-1745450057131-c7847202d433?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        {/* google ad type1*/}
        <section className="w-full py-16 md:py-24 bg-gradient-to-br from-teal-50 to-emerald-50">
          <div className="container px-4 md:px-6 max-w-4xl mx-auto">
            {/* Header */}
            <div className="text-center mb-12">
              <div className="inline-block mb-4 px-4 py-2 text-sm font-medium bg-teal-100 text-teal-800 rounded-full">
            ...
            {/* Problems Section */}
            <div className="mb-12 border-teal-200 bg-teal-50/50">
              <div className="p-8">
                ...
                <div className="mt-6 p-4 bg-teal-100 rounded-lg border-l-4 border-teal-500">
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="hover:shadow-lg transition-shadow border-teal-200">
                  <div className="p-6">
                ...
                <div className="hover:shadow-lg transition-shadow border-teal-200 md:col-span-2 lg:col-span-1">
                  <div className="p-6">
                    <div className="flex items-center mb-4">
            ...
            {/* Summary Section */}
            <div className="mb-12 bg-gradient-to-r from-teal-600 to-emerald-600 text-white border-0">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-teal-200">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <button className="border-teal-600 text-teal-600 hover:bg-teal-50 px-8 py-3 text-lg">
                    ดูข้อมูลเพิ่มเติม
                  </button>
                </div>
...
{/* google ad type2 */}
      ...
      <div className="container px-4 md:px-6 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl text-teal-600 font-semibold">ด้วยบริการทำ Google Ads โดยมืออาชีพ</p>
        </div>

        {/* Questions Section */}
        <div className="mb-12 border-teal-200 bg-white">
          <div className="p-8">
            ...
            <div className="mt-8 p-4 bg-teal-600 text-white rounded-lg text-center">
              ...
              <div className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">ให้โฆษณาของคุณแสดงต่อคนที่ "พร้อมซื้อ"</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Call to Action */}
        <div className="mb-8 bg-white border-2 border-teal-200 shadow-xl">
          <div className="p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="flex flex-col items-center p-4 bg-teal-50 rounded-lg">
                ...
                <p className="text-teal-600 font-medium text-center">099-999-9999</p>
              </div>

              <div className="flex flex-col items-center p-4 bg-teal-50 rounded-lg">
                <Globe className="w-8 h-8 text-teal-600 mb-2" />
                <h4 className="font-semibold text-gray-900 mb-1">🌐 เว็บไซต์</h4>
                <p className="text-teal-600 font-medium text-center">www.youragency.com</p>
              </div>

              <div className="flex flex-col items-center p-4 bg-teal-50 rounded-lg">
                <MessageSquare className="w-8 h-8 text-teal-600 mb-2" />
                <h4 className="font-semibold text-gray-900 mb-1">📱 Line ID</h4>
                <p className="text-teal-600 font-medium text-center">@youragency</p>
              </div>
            </div>

            <div className="flex justify-center">
              <button className= "flex bg-teal-600 hover:bg-teal-700 text-white px-8 py-3 text-lg font-semibold">
                ติดต่อเราตอนนี้
        ...
        {/* Hashtags */}
        <div className="flex flex-wrap justify-center gap-2 text-sm text-teal-600">
          <span className="bg-teal-50 px-3 py-1 rounded-full">#GoogleAds</span>
          <span className="bg-teal-50 px-3 py-1 rounded-full">#การตลาดออนไลน์</span>
          <span className="bg-teal-50 px-3 py-1 rounded-full">#เพิ่มยอดขาย</span>
          <span className="bg-teal-50 px-3 py-1 rounded-full">#ธุรกิจออนไลน์</span>
          <span className="bg-teal-50 px-3 py-1 rounded-full">#DigitalMarketing</span>
          <span className="bg-teal-50 px-3 py-1 rounded-full">#YourAgency</span>
        </div>
      </div>
    </section>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold">
                ร่วมงานกับ{" "}
                <span className="bg-teal-100 px-2 py-1">SamSEOPro</span>{" "}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-gray-600">
                  "หลังจากทำงานร่วมกับทีม SEO ของ SamSEOPro
        ...
        <section className="py-12 bg-[var(--primary)] text-white">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-white text-white hover:bg-white hover:text-teal-700">
                ดูผลงานของเรา
              </button>
            </div>
          </div>
