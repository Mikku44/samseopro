...
type Module = typeof import("../services.seo-training-service.js")

type Info = GetInfo<{
  file: "routes/services.seo-training-service.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../services.seo-training-service.js");
}];
